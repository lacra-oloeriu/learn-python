...
class CentralCorridor(Scene):
    ...
    def enter(self):
        print(dedent("""
             The Gothons of Planet Percal #25 have invaded your skip and
             destroyed your entire crew. You are the last surviving
             membre and your last mission is to get the neutron destruct
             ...
             filled body. He's bloking the door to the Armory and
